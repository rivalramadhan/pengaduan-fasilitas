...
<head>
    ...
    <title>Layanan Pengaduan Fasilitas Umum</title>
    <style>
        /* General Styles */
        body {
            font-family: Arial, sans-serif;
            margin: 0;
            /* MODIFIKASI: Menggunakan helper asset() untuk path gambar */
            background-image: url("{{ asset('img/bg.png') }}");
            background-repeat: no-repeat;
            background-size: 100% auto;
        }
        .main-content { text-align: center; padding: 50px 0; margin: 80px 0 120px 0; color: white; }
        .main-content h1 { margin-bottom: 0; }
        .main-content p { margin-top: 10px; }
        .form-container { background-color: white; border-radius: 10px; width: 60%; max-width: 600px; margin: auto; padding: 40px; box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.1); }
        ...
        .button-group a { text-decoration: none; color: blue; }
...
<body>
    ...
    <div class="form-container">
        ...
        <form action="{{ route('pengaduan.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <input type="text" name="lokasi" placeholder="Lokasi *" autocomplete="off" value="{{ old('lokasi') }}" required>
            </div>
            <div class="form-group">
                <input type="date" id="tanggalInput" name="tanggal_kejadian" placeholder="Tanggal Kejadian" value="{{ old('tanggal_kejadian') }}" required>
            </div>
            <div class="form-group">
